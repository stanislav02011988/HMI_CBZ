...
import qml.content.main_window.main_window_widgets.center_widget.modes.operating_mode
import qml.content.main_window.main_window_widgets.center_widget.modes.edit_mode
