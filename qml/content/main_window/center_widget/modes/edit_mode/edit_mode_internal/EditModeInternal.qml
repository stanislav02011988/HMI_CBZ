...
import qml.content.main_window.center_widget.modes.edit_mode.edit_mode_internal.internal.manager_line
...
Item {
    ...
    function addItemToScene(data) {
        ...
        console.log(`   Всего элементов: ${componentRegister?.count || 0}`)
